  ...
  module Tests
    class ConnectathonCarePlanTrackTest < BaseSuite
      ...
      def setup
        ...
        patient = @resources.generate(FHIR::STU3::Patient, 3)
        ...
        @num_care_teams.times do |t|
          care_team = @resources.generate(FHIR::STU3::CareTeam, 3)
        ...
        care_team_practitioner = @resources.generate(FHIR::STU3::Practitioner, 3)
        create_object(care_team_practitioner, "care_team_practitioner")
        @num_practitioner_care_teams.times do |t|
          care_team = @resources.generate(FHIR::STU3::CareTeam, 3)
          care_team.subject = patient.to_reference
          participant = FHIR::STU3::CareTeam::Participant.new
      ...
      test 'CCPT1','Search for all Care Plans for a Patient' do
        ...
        reply = @client.search(FHIR::STU3::CarePlan, options)
      ...
      test 'CCPT3','Search for all Care Teams for a Patient' do
        ...
        reply = @client.search(FHIR::STU3::CareTeam, options)
        assert_response_ok(reply)
